      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            ...
            named entities that store visual design attributes. They ensure consistency across
            platforms and make theming trivial.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            ...
            <code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">globals.css</code>.
            Change the oklch values under{" "}
            <code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">:root</code> for light
            mode and <code className="bg-muted rounded px-1 py-0.5 font-mono text-xs">.dark</code>{" "}
            for dark mode. All components automatically pick up the new values.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
